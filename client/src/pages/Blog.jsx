                            ...
                            {activePostMenu === post.post_id && (
                              <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="absolute right-0 mt-2 w-48 bg-base-200 rounded-md shadow-lg z-20" onClick={(e) => e.stopPropagation()}>
                                <ul className="py-1">
                                  ...
                                  {currentUserIsAdmin && (
                                    <li>
                                      <button onClick={() => { handleChangePostStatus(post.post_id, post.status !== 'closed' ? 'closed' : 'active'); setActivePostMenu(null); }} className="flex items-center w-full text-left px-4 py-2 text-sm hover:bg-base-300">
                                        ...
                                        {post.status !== 'closed' ? 'Close Post' : 'Re-open Post'}
                                      </button>
                                    </li>
                                  )}
                                </ul>
